...
import com.pack.dao.basicDao;
import com.pack.dao.chooseDao;
import com.pack.dao.noteDao;
import com.pack.dao.userDao;
import com.pack.entity.Basic;
import com.pack.entity.Choose;
import com.pack.entity.Note;
        ...
        if (action.equals("/login")) {
            ...
            try {
                ...
                for (int i = 0; i < items.size(); i++) {
                    ...
                    String opath = sctx.getRealPath("upload/pic_" + user.getId());
            ...
            try {
                ...
                User user = udao.findById(id);
                bdao.update(id, stature, education, marriage, salary, province, city, house, car);
                response.sendRedirect("detail.do?id=" + user.getId());
            } catch (Exception e) {
                e.printStackTrace();
                throw new ServletException(e);
            ...
            try {
                User user = udao.findById(id);
                cdao.update(id, stature, education, marriage, province, city);
                response.sendRedirect("detail.do?id=" + user.getId());
            } catch (Exception e) {
                e.printStackTrace();
                throw new ServletException(e);
